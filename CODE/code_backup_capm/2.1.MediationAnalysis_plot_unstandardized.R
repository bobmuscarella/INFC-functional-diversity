...
png(
  "output_plot/Mod_a_unstandardized.jpg",
  width = 5,
  height = 5,
  units = 'in',
  res = 300
...
png(
  "output_plot/Mod_b_unstandardized.jpg",
  width = 5,
  height = 5,
  units = 'in',
  res = 300
...
png(
  "output_plot/Mod_c_unstandardized.jpg",
  width = 5,
  height = 5,
  units = 'in',
  res = 300
...
png(
  "output_plot/Mod_d_unstandardized.jpg",
  width = 5,
  height = 5,
  units = 'in',
  res = 300
...
png(
  "output_plot/Mod_e_unstandardized.jpg",
  width = 5,
  height = 5,
  units = 'in',
  res = 300
...
png(
  "output_plot/Mod_f_unstandardized.jpg",
  width = 5,
  height = 5,
  units = 'in',
  res = 300
...
png(
  "output_plot/Mod_g_unstandardized.jpg",
  width = 5,
  height = 5,
  units = 'in',
  res = 300
