...
# Mediator effect
Capv_ha_log ~ c(d0,d1) * cwm_StemDensity_log
Capv_ha_log ~ c(e0,e1) * FDis_StemDensity_log
cwm_StemDensity_log ~ c(a0,a1) * vpd
FDis_StemDensity_log ~ c(b0,b1) * vpd
...
# Observed means
Capv_ha_log ~ 1
FDis_StemDensity_log ~ 1
cwm_StemDensity_log ~ 1
vpd ~ 1
'
...
sub.dataset<- dataset[,c('Capv_ha_log','FDis_StemDensity_log','cwm_StemDensity_log','vpd','climate_classification')]
sub.dataset<- na.omit(sub.dataset)
library(piecewiseSEM)
pmultigroup <- psem(
  lm(Capv_ha_log ~ FDis_StemDensity_log + cwm_StemDensity_log+vpd, sub.dataset),
  lm(FDis_StemDensity_log ~ vpd, sub.dataset),
  lm(cwm_StemDensity_log ~ vpd, sub.dataset)
...
#                                                          #
############################################################
(out <- measurementInvariance(model=modD,
                              fixed.x = FALSE,
