...
# Mediator effect
Capv_ha_log ~ c(d0,d1) * cwm_Height_log
Capv_ha_log ~ c(e0,e1) * FDis_Height_log
cwm_Height_log ~ c(a0,a1) * vpd
FDis_Height_log ~ c(b0,b1) * vpd
...
sub.dataset<- dataset[,c('Capv_ha_log','FDis_Height_log','cwm_Height_log','vpd','climate_classification')]
sub.dataset<- na.omit(sub.dataset)
library(piecewiseSEM)
pmultigroup <- psem(
  lm(Capv_ha_log ~ FDis_Height_log + cwm_Height_log+vpd, sub.dataset),
...
Capv_ha_log ~ c(d0,d1) * cwm_Height_log
Capv_ha_log ~ c(e0,e1) * FDis_Height_log
cwm_Height_log ~ c(a0,a0) * vpd
FDis_Height_log ~ c(b0,b0) * vpd
