...
sub.dataset<- dataset[,c('Capv_ha_log','FDis_XylemVulnerability_log','cwm_XylemVulnerability_log','vpd','climate_classification')]
sub.dataset<- na.omit(sub.dataset)
library(piecewiseSEM)
pmultigroup <- psem(
  lm(Capv_ha_log ~ FDis_XylemVulnerability_log + cwm_XylemVulnerability_log+vpd, sub.dataset),
